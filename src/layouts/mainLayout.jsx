...
export default function Index() {
  ...
  //   },
  //   { id: 2, title: 'System update available' },
  //   { id: 3, title: 'Weekly report generated' },
  //   { id: 1, title: 'New message from admin' },
  //   // { id: 2, title: 'System update available' },
  //   // { id: 3, title: 'Weekly report generated' },
  // ];
  ...
  // const userMenuItems = drawerMenuItems.filter(
      ...
      <Box sx={{ display: 'flex', zIndex: '9', position: 'relative' }}>
        ...
        >
          ...
          {/* <List style={{ padding: 0 }}>
            {drawerMenuItems
              ?.filter((_, index) => {
                return role == 'false' ? index === 0 || index === 3 : true;
              })
              .map((item, index) => (
                <Tooltip
                  key={item.name}
            ...
            {drawerMenuItems
              ?.filter(
                (item) =>
                  ...
                  accessModules.includes(item.name)
              )
              .map((item, index) => (
                <Tooltip
                  key={item.name}
